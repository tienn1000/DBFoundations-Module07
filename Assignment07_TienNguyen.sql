...
-- 2024/02/28,TienNguyen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TienNguyen')
	 Begin 
	  Alter Database [Assignment07DB_TienNguyen] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TienNguyen;
	 End
	Create Database Assignment07DB_TienNguyen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TienNguyen;
...
-- <Put Your Code Here> --
--Select ProductName, Format (InventoryDate, 'mm,yyyy') as 'InventoryDate',  Count as InventoryCount
...
With Schemabinding 
AS 
Select Top 10000 ProductName, Format(InventoryDate, 'MMMM,yyyy') as 'InventoryDate', Count as InventoryCount
...
With Schemabinding 
AS 
SELECT Top 100000 CategoryName, Format(InventoryDate, 'MMMM,yyyy') as 'InventoryDate', SUM(Count) as InventoryCountByCategory
FROM dbo.Products as P
...
With Schemabinding 
AS
Select Top 10000 ProductName, InventoryDate, InventoryCount,
